	...
	<body >
		...
		<div>
			<ul>
				...
				<li><a href="calstock.php" >Calculate Stock </a></li>
			...
			<form  action="#" method="post">
				<table class="table">
					<tr>
					<th>Name Of Item:</th>
					<td><input type="text" name="name" placeholder="Enter Name Of Item to remove" required></td>
					</tr>
...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql = "DELETE FROM `additem` WHERE name='$name'" ;
		if ($conn->query($sql) == TRUE) {
				echo "<center>You have successfully Deleted items From database.</center>";
			} 	
			else {
